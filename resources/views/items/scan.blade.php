...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('icon-sgm.ico') }}">
<link rel="shortcut icon" href="{{ asset('icon-sgm.ico') }}">
<link rel="apple-touch-icon" href="{{ asset('icon-sgm.ico') }}">
